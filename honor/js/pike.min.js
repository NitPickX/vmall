! function(e, t, i) {
    function o(e, t) {
        ...
        $(e + " img").attr("draggable", "false"), $(e + " img").css("-moz-user-select", "none");
        var o, r, s, n, l, a, c, p, h, d, g, u;
        o = $(e).children(".pike"), l = $(e).children(".pike_prev"), a = $(e).children(".pike_next"), c = $(e).children(".pike_spot"), o.width(), o.height(), r = o.children();
        ...
        if (h = 1 === t.arrowBackground ? "255,255,255" : 2 === t.arrowBackground ? "1,1,1" : h, t.arrowList) {
            var w, v;
            t.arrowList.width && !t.arrowList.height ? (w = '<img width="' + t.arrowList.width + '" src="' + t.arrowList.left + '" draggable="false"></img>', v = '<img width="' + t.arrowList.width + '" src="' + t.arrowList.right + '" draggable="false"></img>') : t.arrowList.height && !t.arrowList.width ? (w = '<img height="' + t.arrowList.height + '" src="' + t.arrowList.left + '" draggable="false"></img>', v = '<img height="' + t.arrowList.height + '" src="' + t.arrowList.right + '" draggable="false"></img>') : t.arrowList.width && t.arrowList.height ? (w = '<img width="' + t.arrowList.width + '" height="' + t.arrowList.height + '" src="' + t.arrowList.left + '"draggable="false"></img>', v = '<img width="' + t.arrowList.width + '" height="' + t.arrowList.height + '" src="' + t.arrowList.right + '"draggable="false"></img>') : (w = '<img src="' + t.arrowList.left + '"draggable="false"></img>', v = '<img src="' + t.arrowList.right + '"draggable="false"></img>'), l.append(w), a.append(v), l.children("img").addClass("pike_img"), a.children("img").addClass("pike_img")
        } else l.append("<"), a.append(">"), l.width("70px"), l.height("70px"), a.width("70px"), a.height("70px"), l.css({
            color: t.arrowColor,
            ...
            var b, x;
            b = t.spotList.backgroundImg ? "url(" + t.spotList.backgroundImg + ") no-repeat" : t.spotList.color, x = t.spotList.select.backgroundImg ? "url(" + t.spotList.select.backgroundImg + ") no-repeat" : t.spotList.select.color, c.append(p), c.children().css({
            ...
            for (var m = 0; m < r.length; m++) p += '<li class="spot"></li>';
            c.append(p), c.children().eq(0).css("background", t.spotSelectColor || "green"), c.children(".spot").css("opacity", t.spotTransparent || 1)
        }
        ...
        var L = function() {
            ...
            y = function() {
                ...
                if (s = 0, t.loop && (g = r.first().clone(), o.append(g)), u = o.children().length, 2 === t.type) {
                    o.css("width", r.width() * r.length), o.css("width", r.width() * u);
                    ...
                    o.css("height", r.height() * r.length), o.css("height", r.height() * u)
                }
                var f = function() {
                        s == u && (2 === t.type ? o.css({
                            left: 0
                            ...
                            top: 0
                        }), s = 1), -1 == s && (2 === t.type ? o.css({
                            left: -(u - 1) * r.eq(0).width()
                        }) : 3 === t.type && o.css({
                            top: -(u - 1) * r.eq(0).height()
                        }), s = u - 2), 2 === t.type ? o.stop().animate({
                            left: -s * r.eq(0).width()
                        }, t.slide || 800) : 3 === t.type && o.stop().animate({
                            top: -s * r.eq(0).height()
                        }, t.slide || 800), s == u - 1 ? t.spotList ? c.children().eq(0).css({
                            width: t.spotList.select.width + "px",
                            margin: "6px 6px",
                            cursor: "pointer",
                            height: t.spotList.select.height + "px",
                    ...
                    w = function() {
                        s == u ? s = u - 1 : -1 == s && (s = 0), 2 == t.type ? o.stop().animate({
                            left: -s * r.eq(0).width()
                        }, t.slide || 800) : 3 == t.type && o.stop().animate({
                            top: -s * r.eq(0).height()
                        }, t.slide || 800), t.spotList ? c.children().eq(s).css({
                            width: t.spotList.select.width + "px",
                            margin: "6px 6px",
                            cursor: "pointer",
                            height: t.spotList.select.height + "px",
                ...
                if (t.automatic && (n = setInterval(function() {
                    ...
                    clearInterval(n), d && (t.loop ? (s++, f()) : (s++, w()), L())
                }), l.click(function() {
                    clearInterval(n), d && (t.loop ? (s--, f()) : (s--, w()), L())
                    ...
                    s = c.children().index(this), 2 === t.type ? o.stop().animate({
                        left: -s * r.eq(0).width()
                    }, 500) : 3 === t.type && o.stop().animate({
                        top: -s * r.eq(0).height()
                    }, 500), k(s), L()
                }), t.mousewheel && $(e).on("mousewheel DOMMouseScroll", function(e) {
                    ...
                    $(e).on("mousedown", function(e) {
                        e = e || window.event, I = !0, v = e.clientX, q = e.clientY
                    }), $(e).on("mousemove", function(e) {
                        e = e || window.event, m = e.clientX, y = e.clientY, i()
                    }), $(e).on("mouseup", function(e) {
                        I = !1, p()
                    }), document.querySelector(e).ontouchstart = function(e) {
                        e = e || window.event, I = !0, v = e.touches[0].clientX, q = e.touches[0].clientY
                    }, document.querySelector(e).ontouchmove = function(e) {
                        e = e || window.event, m = e.touches[0].clientX, y = e.touches[0].clientY, i()
        ...
        switch (t.type) {
            case 1:
                ! function() {
                    ...
                    r.eq(0).show(), s = 0;
                    var o = function() {
                            s = s == r.length ? 0 : s, r.eq(s).fadeIn(500).siblings().fadeOut(500), k(s)
                        },
                        p = function() {
                            s < 0 ? s = 0 : s == r.length && (s = r.length - 1), r.eq(s).fadeIn(500).siblings().fadeOut(500), k(s)
                        },
                        h = function() {
                    ...
                    t.automatic && h(), t.hover && $(e).hover(function() {
                        clearInterval(n)
                    }, function() {
                        t.automatic && h()
                    }), l.click(function() {
                        clearInterval(n), t.loop ? (s--, s = s < 0 ? r.length - 1 : s, o()) : (s--, p()), L()
                    }), a.click(function() {
                        clearInterval(n), t.loop ? (s++, o()) : (s++, p()), L()
                    });
                    var g = c.children(".spot");
                    if (g.click(function() {
                        clearInterval(n), d && (s = g.index(this), o(), L())
                    }),  s = 0, !1 !== t.drag) {
                        var u, f, w, v, m = !1;
                        $(e).mousedown(function(e) {
                            e = e || window.event, m = !0, u = e.clientX, v = e.clientY
                        }), $(e).mousemove(function(e) {
                            e = e || window.event, f = e.clientX, w = e.clientY
                        }), $(e).mouseup(function() {
                            m = !1, $(e).width() / 2 <= u - f + $(e).width() / 3 ? (event.preventDefault(), clearInterval(n), t.loop ? (s++, o()) : (s++, p()), L()) : $(e).width() / 2 <= f - u + +$(e).width() / 3 && (event.preventDefault(), clearInterval(n), t.loop ? (s--, s = s < 0 ? r.length - 1 : s, o()) : (s--, p()), L())
                        })
                    }
                }();
                break;
